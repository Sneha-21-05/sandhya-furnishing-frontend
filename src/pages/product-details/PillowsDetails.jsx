    ...
    <div className="bg-gray-50 min-h-screen font-sans text-gray-800 flex flex-col pt-8">
      <main className="flex-1 max-w-7xl mx-auto px-6 py-8 sm:py-12 w-full space-y-12">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          {/* DIMENSION IMAGE */}
          {dimensionImage ? (
            <div className="bg-[#142C2C] rounded-[2rem] p-10 text-white shadow-xl flex flex-col justify-center">
            ...
            <div className="bg-white rounded-[2rem] border-2 border-dashed border-gray-300 flex items-center justify-center min-h-[350px]">
